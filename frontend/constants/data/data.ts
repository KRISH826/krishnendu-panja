...
export const experiences: Experience[] = [
    {
        ...
        date: "2020-2021",
        contents: [
            "Developed responsive and interactive web interfaces for diverse clients using Html and WordPress.",
            "Translated client requirements into clean, maintainable code and pixel-perfect UI designs.",
            "Optimized application performance and implemented reusable components to enhance scalability.",
            "Collaborated with designers and back-end developers to deliver end-to-end user-focused solutions on time.",
        ],
    },
    {
        ...
        date: "2021-2022",
        contents: [
            "Created user-friendly, aesthetically pleasing interfaces for frontend implementation using Figma and Photoshop to design and enhance web/mobile interfaces according to product specifications",
            "Conducted usability testing and user research to identify user pain points and inform design iterations, achieving 10% increase in user journey completion on critical experience flows",
            "Designed and refined fully responsive web interfaces following accessibility and performance best practices, ensuring flawless user experiences across all devices.",
        ],
    },
    {
