        ...
        <section className="relative w-full h-screen min-h-[700px] overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col h-full w-full">
                ...
                <div className="flex-1 container mx-auto flex flex-col justify-center pb-16 md:pb-24">
                    <div className="max-w-4xl sm:mt-10 mt-8">
                        ...
                        <h1 className="text-white text-[40px] sm:text-[52px] md:text-[60px] lg:text-[68px] font-medium leading-[1.05] tracking-tight mb-6 md:mb-8">
                            ...
                            <em className="block overflow-hidden italic font-normal pb-1">
                ...
                <div className="container relative mx-auto">
                    {/* ─── Bottom Bar ─── */}
                    <div className="w-full pb-8 md:pb-10 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6">
                    ...
                    <motion.div
                        className="absolute bottom-6 md:bottom-7 left-0 lg:-left-2 w-12 h-12 pointer-events-none hidden md:block"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
