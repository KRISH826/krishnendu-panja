                ...
                {data.map((item, index) => (
                    ...
                    >
                        <div className="flex flex-col z-40 items-center self-start">
                            ...
                            <h3 className="hidden md:block md:w-[650px] text-xl md:pl-20 md:text-4xl font-bold text-neutral-400 dark:text-neutral-500 ">
                                {item.title}
                            </h3>
                        </div>
                        <div className="relative pl-20 pr-4 md:pl-20 w-full">
                            <h3 className="md:hidden block sm:text-2xl text-xl mb-2 text-left font-bold text-neutral-500 dark:text-neutral-500">
                                {item.title}
                            </h3>
                            ...
                            <p className='sm:text-base text-sm text-white/80'>{item.contents}</p>
                        </div>
                    </div>
                ))}
                <div
